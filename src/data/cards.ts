...
/** 한글 이름 → romanized(에셋 파일명). 동일 캐릭터도 단계별로 서로 다른 이름·romanized. */
export const ROMAN: Record<string, string> = {
  // 1단계
  손오공: "goku", 베지터: "vegeta", "소년 오반": "gohan", 트랭크스: "trunks", 프리저: "frieza",
  "불완전체 셀": "cell", "뚱보 부우": "buu_fat", 피콜로: "piccolo", 브로리: "broly", "베이비": "baby",
  베지트: "vegito", 고구스: "gogeta", 오천크스: "gotenks", 손오천: "goten", 천진반: "tenshinhan",
  // 2단계
  "초사이어인 오공": "goku_ss", "초사이어인 베지터": "vegeta_ss", "초사이어인2 오반": "gohan_ss2", "초사이어인 트랭크스": "trunks_ss", "최종형태 프리저": "frieza_final",
  "준완전체 셀": "cell_semi", "사악한 부우": "buu_evil", "합체 피콜로": "piccolo_fused", "초사이어인 브로리": "broly_ss", "슈퍼 베이비": "baby_super",
  "초사이어인 베지트": "vegito_ss", "초사이어인 고구스": "gogeta_ss", "초사이어인 오천크스": "gotenks_ss", "초사이어인 손오천": "goten_ss", "사공권 천진반": "tenshinhan_4arms",
  // 3단계
  "초사이어인4 오공": "goku_ss4", "초사이어인4 베지터": "vegeta_ss4", "궁극의 오반": "gohan_ultimate", "분노의 트랭크스": "trunks_rage", "풀파워 프리저": "frieza_full",
  "완전체 셀": "cell_perfect", "키드 부우": "buu_kid", "신 합체 피콜로": "piccolo_kami", "전설의 초사이어인": "broly_legendary", "슈퍼 베이비2": "baby_super2",
  "슈퍼 베지트": "vegito_super", "초사이어인4 고구스": "gogeta_ss4", "초사이어인3 오천크스": "gotenks_ss3", "초사이어인2 손오천": "goten_ss2", "신기공포 천진반": "tenshinhan_max",
  // 희귀
  크리링: "krillin", 덴데: "dende", 무천도사: "roshi", "미스터 사탄": "hercule", 계왕: "kingkai",
  // 전설
  신룡: "shenron", 폴룽가: "porunga", "오메가 흑성룡": "omega_shenron", 우브: "uub", 바독: "bardock",
};
...
const LINES: readonly LineSpec[] = [
  { color: "blue", s1: "손오공", s2: "초사이어인 오공", s3: "초사이어인4 오공" },
  { color: "yellow", s1: "베지터", s2: "초사이어인 베지터", s3: "초사이어인4 베지터" },
  { color: "red", s1: "소년 오반", s2: "초사이어인2 오반", s3: "궁극의 오반" },
  { color: "pink", s1: "트랭크스", s2: "초사이어인 트랭크스", s3: "분노의 트랭크스" },
  { color: "black", s1: "프리저", s2: "최종형태 프리저", s3: "풀파워 프리저" },
  { color: "blue", s1: "불완전체 셀", s2: "준완전체 셀", s3: "완전체 셀" },
  { color: "yellow", s1: "뚱보 부우", s2: "사악한 부우", s3: "키드 부우" },
  { color: "red", s1: "피콜로", s2: "합체 피콜로", s3: "신 합체 피콜로" },
  { color: "pink", s1: "브로리", s2: "초사이어인 브로리", s3: "전설의 초사이어인" },
  { color: "black", s1: "베이비", s2: "슈퍼 베이비", s3: "슈퍼 베이비2" },
  { color: "blue", s1: "베지트", s2: "초사이어인 베지트", s3: "슈퍼 베지트" },
  { color: "yellow", s1: "고구스", s2: "초사이어인 고구스", s3: "초사이어인4 고구스" },
  { color: "red", s1: "오천크스", s2: "초사이어인 오천크스", s3: "초사이어인3 오천크스" },
  { color: "pink", s1: "손오천", s2: "초사이어인 손오천", s3: "초사이어인2 손오천" },
  { color: "black", s1: "천진반", s2: "사공권 천진반", s3: "신기공포 천진반" },
];
...
const RARE: readonly (readonly [name: string, color: Color, cost: ColorMap])[] = [
  ["크리링", "red", { black: 3, blue: 2 }],
  ["덴데", "blue", { pink: 3, yellow: 2 }],
  ["무천도사", "yellow", { blue: 3, pink: 2 }],
  ["미스터 사탄", "pink", { red: 3, black: 2 }],
  ["계왕", "black", { yellow: 3, red: 2 }],
];

/** 전설 카드 스펙: [이름, 보너스색, 비용]. 점수 2, 보너스 2. */
const LEGENDARY: readonly (readonly [name: string, color: Color, cost: ColorMap])[] = [
  ...
  ["우브", "pink", { blue: 3, yellow: 3, black: 3 }],
  ["바독", "black", { pink: 3, red: 3, blue: 3 }],
];
